...
Consider the Pandas python library, this is essentially an abstraction which allows us to work with and analyze data with ease.

You can explicity convert a dataframe to an rdd by calling `.rdd` method on the dataframe.
