...
```shell
MASTER_URL = 'spark://f22e994ff136:7077'
BUCKET_NAME = "your-bucket-name"
GREEN_PATH = f"gs://{BUCKET_NAME}/ny_taxi_data/service=green/year=2019/month=*"
YELLOW_PATH = f"gs://{BUCKET_NAME}/ny_taxi_data/service=yellow/year=2019/month=*"
OUTPUT_PATH = f"gs://{BUCKET_NAME}/ny_taxi_data/report/year=2019/revenue"
```
