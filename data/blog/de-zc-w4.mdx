...
and one year (2019), which seemingly worked, but on further review, I found a plethora of issues when attempting to ingest the yellow taxi data, etc with Mage. My pipeline was failing because I was loading
