...
For the sake of this blog post, I will share the `external_fhv_tripdata.sql` model I first auto-generated but then later modeled after the green and yellow tripdata models. 
